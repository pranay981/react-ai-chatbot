...
1.git clone https://github.com/pranay981/react-ai-chatbot.git
2.cd react-ai-chatbot
3.npm install
4.VITE_API_KEY=your_api_key_here
5.VITE_API_URL=https://api.example.com/endpoint
6.npm run dev
7.This project integrates the following API(s):
